use TV
go
--Год, месяц, город, страна, количество репортажей из этой страны в месяц, средняя продолжительность репортажа.
...
--Вывести города в порядке возрастания общего кол-ва репортажей в них и это кол-во
